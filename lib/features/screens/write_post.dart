                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(' username', style: ReusableStyles.titleTextStyle.copyWith(fontSize: 14.0)),
                            ]
                          ),
                            ...
                            children: [
                              Column(
                                children: [
                                  Row(
                                    children: [
                                      SvgPicture.asset(AssetsConstants.cameraIcon, height: 24.0),
                                      SizedBox(width: MediaQuery.of(context).size.width * 0.04),
                                      SvgPicture.asset(AssetsConstants.folderIcon, height: 24.0),
                                    ]
                                  )
                                ]
                              ),
                              SvgPicture.asset(AssetsConstants.glassesIcon, height: 20.0),
                            ]
                          ),
                        ],
                      ),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  SvgPicture.asset(AssetsConstants.checkActive, height: 22.0),
                                ],
                              ),
                              SizedBox(height: MediaQuery.of(context).size.height * 0.01),
                              Text(
